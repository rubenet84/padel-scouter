...
function renderPlayer(p, analyses) {
    ...
    if (manoEl) {
        ...
        manoEl.innerHTML = '<img src="/static/images/' + icono + '" style="width:64px;height:64px;border-radius:50%;border:3px solid rgba(255,107,0,0.3);object-fit:cover;"><span style="color:rgba(255,107,0,0.8);font-size:16px;font-family:Orbitron,sans-serif;font-weight:900;margin-top:4px;">' + manoVal + '</span>';
    ...
    if (latest) {
        ...
        if (suggestedEl) {
          ...
          suggestedEl.innerHTML = '<span style="font-family:Orbitron,sans-serif;font-size:14px;font-weight:900;color:#FFD700;">Sugerida: ' + suggested + '</span>';
